...
if (isset($_POST["search_job_title"])){
$query = $_POST['search_job_title'];
$query = htmlspecialchars($query); 
        // changes characters used in html to their equivalents, for example: < to &gt;

$sql= "SELECT id, employer_name, name, salary,job_level, category, location_city, job_time,sponsorship, location_country, date_posted from job_listing WHERE (name LIKE '%".$query."%' OR category LIKE '%".$query."%' OR job_type LIKE '%".$query."%' OR employer_name LIKE '%".$query."%');";

}
elseif(isset($_POST["search_location"])){
$query = $_POST['search_location'];
$query = htmlspecialchars($query); 
$sql= "SELECT id, employer_name, name, salary,job_level, category, location_city, job_time,sponsorship, location_country, date_posted from job_listing WHERE (location_country LIKE '%".$query."%' OR location_city LIKE '%".$query."%');";
