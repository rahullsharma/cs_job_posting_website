...
include('employer_topnav.html');
 ...
 $db = new mysqli($hn, $un, $pw, $db);
  ...
  $sql = "INSERT INTO job_listing (employer_name, name, salary, category,details,location_city, location_country, job_level, job_type,job_time,sponsorship,equity) VALUES (?, ?,?, ?,?, ?, ?, ?, ?, ?, ?, ?)";
